...
function Home() {
  return (
    <div>
      <h2>Home</h2>
    <p style={{color:"gray"}}>A job is any legal activity that allows an individual to perform a service and in return earn credits they can use to buy things.
